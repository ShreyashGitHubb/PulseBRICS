      ...
      <div className="gcp-card p-5 relative overflow-hidden flex flex-col md:flex-row md:items-center justify-between gap-4 border-l-4 border-l-[#4285F4]">
        <div className="space-y-1">
          <div className="flex items-center space-x-2">
            <span className="text-[11px] font-mono font-bold text-[#1A73E8] dark:text-[#8AB4F8] bg-[#1A73E8]/10 px-2 py-0.5 rounded border border-[#1A73E8]/30 flex items-center space-x-1">
        ...
        <div className="flex items-center space-x-2">
          <button
            ...
            className="px-3.5 py-2 rounded-lg bg-[#F1F3F4] hover:bg-[#E8EAED] dark:bg-[#28292A] dark:hover:bg-[#35363A] text-slate-800 dark:text-slate-200 text-xs font-semibold border border-[#DADCE0] dark:border-[#3C4043] transition-colors cursor-pointer"
          >
            Open Facility Directory
          </button>
          <button
            onClick={() => setActiveTab('MAP')}
            className="px-3.5 py-2 rounded-lg bg-[#1A73E8] hover:bg-[#1557B0] text-white text-xs font-semibold transition-colors shadow-sm cursor-pointer"
          >
            Geospatial Mesh Map
          </button>
        </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="gcp-card p-4 space-y-2 relative overflow-hidden border-t-2 border-t-[#4285F4]">
          <div className="flex items-center justify-between text-slate-500 dark:text-slate-400">
            ...
            <Building2 className="w-4 h-4 text-[#1A73E8] dark:text-[#8AB4F8]" />
          </div>
          <div className="flex items-baseline space-x-2">
            <span className="text-2xl font-bold text-slate-900 dark:text-white tabular-nums">{totalPHCs}</span>
            <span className="text-xs text-slate-500 dark:text-slate-400 font-mono">{selectedCountry.unit}s</span>
          </div>
          <div className="text-[11px] text-slate-500 dark:text-slate-400 pt-1 border-t border-[#DADCE0] dark:border-[#3C4043] flex items-center justify-between">
        ...
        <div className={`gcp-card p-4 space-y-2 relative overflow-hidden border-t-2 border-t-[#EA4335] ${
          ...
          <div className="flex items-center justify-between text-slate-500 dark:text-slate-400">
            ...
            <AlertTriangle className={`w-4 h-4 ${criticalNodes.length > 0 ? 'text-[#EA4335] dark:text-[#F28B82]' : 'text-slate-400'}`} />
          </div>
          <div className="flex items-baseline space-x-2">
            <span className={`text-2xl font-bold tabular-nums ${criticalNodes.length > 0 ? 'text-[#EA4335] dark:text-[#F28B82]' : 'text-slate-900 dark:text-white'}`}>
              {criticalNodes.length}
            </span>
            <span className="text-xs text-slate-500 dark:text-slate-400">Immediate Risk</span>
          </div>
          <div className="text-[11px] text-slate-500 dark:text-slate-400 pt-1 border-t border-[#DADCE0] dark:border-[#3C4043] flex items-center justify-between">
        ...
        <div className="gcp-card p-4 space-y-2 relative overflow-hidden border-t-2 border-t-[#34A853]">
          <div className="flex items-center justify-between text-slate-500 dark:text-slate-400">
            ...
            <Pill className="w-4 h-4 text-[#188038] dark:text-[#81C995]" />
          </div>
          <div className="flex items-baseline space-x-2">
            <span className="text-2xl font-bold text-slate-900 dark:text-white tabular-nums">{totalMedicines.toLocaleString()}</span>
            <span className="text-xs text-slate-500 dark:text-slate-400 font-mono">Live Vials</span>
          </div>
          <div className="text-[11px] text-slate-500 dark:text-slate-400 pt-1 border-t border-[#DADCE0] dark:border-[#3C4043] flex items-center justify-between">
            <span>10 Essential Drug Classes</span>
            <span className="text-[#188038] dark:text-[#81C995] font-mono">FEFO Managed</span>
          </div>
        </div>
        ...
        <div className="gcp-card p-4 space-y-2 relative overflow-hidden border-t-2 border-t-[#FBBC04]">
          <div className="flex items-center justify-between text-slate-500 dark:text-slate-400">
            ...
            <ThermometerSnowflake className="w-4 h-4 text-[#FBBC04]" />
          </div>
          <div className="flex items-baseline space-x-2">
            <span className="text-2xl font-bold text-slate-900 dark:text-white tabular-nums">99.4%</span>
            <span className="text-xs text-[#E37400] dark:text-[#FDD663] font-mono">2°C - 8°C</span>
          </div>
          <div className="text-[11px] text-slate-500 dark:text-slate-400 pt-1 border-t border-[#DADCE0] dark:border-[#3C4043] flex items-center justify-between">
            <span>Solar & Phase-Change</span>
            <span className="text-[#E37400] dark:text-[#FDD663] font-mono">Monitored</span>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-7 space-y-3">
          <div className="flex items-center justify-between">
            ...
            <span className="text-xs text-slate-500 dark:text-slate-400">Ranked by Resilience Score</span>
          </div>
                  ...
                  <div className="flex items-center justify-between pt-2 border-t border-[#DADCE0] dark:border-[#3C4043]">
                    ...
                    <div className="flex items-center space-x-2">
                      <button
                        ...
                        className="px-2.5 py-1.5 rounded-lg bg-[#F1F3F4] hover:bg-[#E8EAED] dark:bg-[#28292A] dark:hover:bg-[#35363A] text-slate-700 dark:text-slate-200 text-xs font-medium border border-[#DADCE0] dark:border-[#3C4043] flex items-center space-x-1.5 transition-colors cursor-pointer"
                      >
                        <TrendingUp className="w-3.5 h-3.5 text-[#FBBC04]" />
