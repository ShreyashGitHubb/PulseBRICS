        ...
        <div className="flex items-center space-x-2 flex-wrap gap-2">
          <div className="relative w-64">
            ...
            <input
              ...
              className="w-full bg-[#131314] text-xs text-slate-200 pl-8 pr-3 py-1.5 rounded-lg border border-[#3C4043] focus:outline-none focus:border-[#1A73E8]"
            />
          </div>
          ...
          <select
            ...
            className="bg-[#131314] text-xs text-slate-300 px-3 py-1.5 rounded-lg border border-[#3C4043] focus:outline-none focus:border-[#1A73E8] cursor-pointer"
          >
      ...
      <div className="gcp-card overflow-hidden">
        <div className="overflow-x-auto">
          <table className="w-full text-left text-xs">
            <thead className="bg-[#131314] text-slate-400 font-semibold border-b border-[#3C4043] uppercase tracking-wider text-[10px]">
              <tr>
              ...
              {filtered.map(phc => {
                ...
                return (
                  <tr
                    ...
                    className="hover:bg-[#28292A] cursor-pointer transition-colors"
                  >
                    <td className="py-3 px-4">
                      <div className="font-semibold text-white">{phc.name}</div>
                      <div className="text-[10px] font-mono text-[#8AB4F8] mt-0.5">{phc.id}</div>
                    </td>

                    <td className="py-3 px-4 text-slate-300">
                      <div>{phc.district}</div>
                      <div className="text-[10px] text-slate-400">{phc.state}</div>
                    </td>

                    <td className="py-3 px-4">
                      <div className="flex items-center space-x-2">
                        <div className="w-16 h-1.5 bg-[#131314] rounded-full overflow-hidden border border-[#3C4043]">
                          <div
                        ...
                        <span className="font-mono font-bold text-white">{phc.resilienceScore}%</span>
                      </div>
                    </td>
                    ...
                    <td className="py-3 px-4 text-right" onClick={(e) => e.stopPropagation()}>
                      <div className="flex items-center justify-end space-x-1.5">
                        <button
                          ...
                          className="p-1.5 rounded-lg bg-[#1E1F20] hover:bg-[#35363A] text-slate-200 border border-[#3C4043]"
